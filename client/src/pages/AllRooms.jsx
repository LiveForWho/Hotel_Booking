...
const AllRooms = () => {
  ...
  const roomsType = ["Single Bed", "Double Bed", "Luxury Room", "Family Suite"];
  const priceRanges = [
    "0 to 500",
    "500 to 1000",
    "1000 to 2000",
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 1g:px-24 x1:px-32">
      ...
      {/* Filters */}
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-1g:mb-8 min-lg:mt-16">
        <div
